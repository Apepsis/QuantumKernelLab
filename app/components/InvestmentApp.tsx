...
import QuantumKernelLab from "@/app/components/QuantumKernelLab";
import {
  demoAlerts,
  demoBacktest,
  demoBuildJournal,
...
type View = "dashboard" | "analysis" | "research" | "quantum" | "portfolio" | "watchlist" | "methodology" | "construction" | "journal" | "settings";
...
const nav: { id: View; label: string; glyph: string }[] = [
  ...
  { id: "quantum", label: "Quantum Lab", glyph: "Q" },
...
export default function InvestmentApp() {
  ...
  const [quantumKernel, setQuantumKernel] = useState<QuantumKernelDataset>(demoQuantumKernel);
  ...
  useEffect(() => {
    const resources: Array<[string, (value: never) => void]> = [
      ...
      ["data/quantum_kernel_lab.json", (value) => setQuantumKernel(value as QuantumKernelDataset)],
    ];
  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        {view === "quantum" && <QuantumKernelLab quantum={quantumKernel} />}
