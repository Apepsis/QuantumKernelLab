import type {
  ...
  QuantumKernelDataset,
  ResearchManifest,
  RiskDataset,
} from "@/lib/types";

export const demoQuantumKernel: QuantumKernelDataset = {
  schemaVersion: 1,
  generatedAt: "Sin ejecutar",
  mode: "protocol",
  status: "awaiting-manual-run",
  experimentId: "quantum-kernel-shadow-v1",
  ...
  design: {
    ...
    qubits: 4,
    featureMap: { name: "ZZFeatureMap", repetitions: 2, entanglement: "linear", shots: null },
    sampling: { maximumFitRows: 240, maximumCalibrationRows: 96, maximumTestRows: 120, maximumFolds: 3 },
    baselines: ["logistic", "rbfSvm"],
    quantumModels: ["quantumZZ"],
  },
  features: ["ret_5", "ret_20", "ret_60", "sma_50_ratio", "sma_200_ratio", "rsi_14", "vol_20", "vol_60", "drawdown_252", "volume_z_20", "spy_ret_20", "spy_ret_60", "spy_sma_200_ratio", "spy_vol_60", "beta_60"],
  aggregateResults: [],
  foldResults: [],
  bootstrap: [],
  governance: {
    role: "shadow-challenger",
    promotionPolicy: { minimumCompletedFolds: 3, minimumHorizonsWon: 2, minimumBrierImprovement: 0.002, maximumEceDegradation: 0.01, automaticPromotion: false },
    eligibleForPromotion: false,
    automaticPromotion: false,
    decision: "No ejecutado. Ningún resultado cuántico modifica el modelo oficial.",
  },
  reproducibility: { seed: 20260821, configHash: "pendiente", gitCommit: "pendiente", python: "3.12", backend: "FidelityStatevectorKernel exact simulation" },
  limitations: ["El simulador se ejecuta en hardware clásico.", "Una mejora predictiva no demuestra ventaja computacional cuántica.", "El experimento no ejecuta operaciones."],
  sources: [
